...
return [
    ...
    */
    'auth' => [
        ...
        // Add "remember me" to login form是否展示保持登陆选项
        'remember' => true,

        // 登陆页面URL
        'redirect_to' => 'auth/login',

        // The URIs that should be excluded from authorization.无需认证即可访问的地址
        'excepts' => [
            'auth/login',
            'auth/logout',
        ],
    ...
    */
    'database' => [
        ...
        // Pivot table for table above.多对多关联中间表模型
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Admin map field provider 默认地图组件提供商
    |--------------------------------------------------------------------------
    |
